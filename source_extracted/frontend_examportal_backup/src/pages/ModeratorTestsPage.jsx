        ...
        return (
            <div className="min-h-screen bg-gray-950 flex items-center justify-center">
                <div className="flex flex-col items-center">
                    ...
                    <p className="text-gray-500 text-xs font-semibold uppercase tracking-widest">Loading assessments...</p>
                </div>
            </div>
        );
    }
        ...
        <div className="min-h-screen bg-gray-950 text-gray-200">
            <div className="max-w-7xl mx-auto px-6 py-8">
                ...
                <header className="flex flex-col md:flex-row justify-between items-center mb-10 gap-6">
                    ...
                    <div className="flex items-center space-x-4 w-full md:w-auto">
                        <div className="relative flex-1 md:flex-none">
                            <Search className="absolute left-3 top-1/2 -trangray-y-1/2 text-gray-500" size={16} />
                            <input
                                type="text"
                                placeholder="Search tests..."
                                value={searchQuery}
                                onChange={(e) => setSearchQuery(e.target.value)}
                                className="w-full md:w-64 pl-10 pr-4 py-2.5 bg-gray-900 border border-gray-800 rounded-xl text-sm text-white placeholder:text-gray-600 focus:border-blue-500/50 transition-all"
                            />
                        </div>
                        <button
                        ...
                        <button
                            ...
                            className="p-2.5 bg-gray-900 border border-gray-800 rounded-xl text-gray-500 hover:text-rose-400 hover:border-rose-500/30 transition-all"
                            title="Sign Out"
                        >
                            <LogOut size={20} />
                        </button>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-10">
                    {[
                        { label: 'Total Assessments', value: stats.total, icon: FileText, color: 'text-blue-400', bg: 'bg-blue-500/10', border: 'border-blue-500/20' },
                        ...
                        <div key={i} className="prof-panel p-6 group">
                            <div className="flex items-center justify-between">
                                <div>
                                    <p className="text-[11px] font-bold text-gray-500 uppercase tracking-wider mb-2">{stat.label}</p>
                                        ...
                                        <tr key={test.id} className="group">
                                            <td>
                                                <div className="flex flex-col">
                                                    ...
                                                    <span className="text-xs text-gray-500 mt-0.5 line-clamp-1 max-w-xs">
                                            ...
                                            <td>
                                                <div className="flex items-center text-gray-400 tabular-nums">
                                            ...
                                            <td>
                                                <div className="flex items-center justify-end space-x-2">
                                                    <button
                                                        ...
                                                        className="p-2 bg-gray-800/50 hover:bg-blue-600/20 text-blue-400 rounded-lg transition-colors border border-transparent hover:border-blue-500/30"
                                                        title="Edit Protocol"
                                                    >
                                                        <Edit size={16} />
                                                    </button>
                                                    <button
                                                        ...
                                                        className="p-2 bg-gray-800/50 hover:bg-violet-600/20 text-violet-400 rounded-lg transition-colors border border-transparent hover:border-violet-500/30"
                                                        title="Analytics"
                                                    >
                                                        <BarChart2 size={16} />
                                                    </button>
                                                    <button
                                                        ...
                                                        className={`p-2 bg-gray-800/50 rounded-lg transition-colors border border-transparent ${test.status === 'PUBLISHED'
                                                    ...
                                                    <button
                                                        ...
                                                        className="p-2 bg-gray-800/50 hover:bg-rose-600/20 text-rose-400 rounded-lg transition-colors border border-transparent hover:border-rose-500/30"
