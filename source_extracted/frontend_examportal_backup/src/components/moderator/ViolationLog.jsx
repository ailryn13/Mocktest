  ...
  return (
    <aside className="prof-panel h-full flex flex-col overflow-hidden">
      <div className="p-4 border-b border-gray-800 flex items-center justify-between bg-gray-900/40">
        <h2 className="text-[11px] font-bold uppercase tracking-widest flex items-center space-x-2 text-gray-300">
        ...
        {recentViolations.length === 0 ? (
          ...
          recentViolations.map((violation, index) => {
            ...
            return (
              <div
                key={index}
                className="p-3 rounded-lg bg-gray-900/50 border border-gray-800 hover:border-gray-700 transition-all group"
              >
                <div className="flex items-start justify-between mb-2">
                  ...
                  <div className="flex items-center space-x-1 text-[10px] font-medium text-gray-500 tabular-nums">
                    <Clock size={10} />
                ...
                {violation.totalStrikes !== undefined && (
                  <div className="flex items-center justify-between pt-2 border-t border-gray-800/50">
                    <span className="text-[9px] font-semibold text-gray-500 uppercase tracking-wider">Accumulated Strikes</span>
