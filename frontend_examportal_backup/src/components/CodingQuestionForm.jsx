            ...
            <div>
                ...
                <div className="mt-1">
                    <textarea
                        ...
                        rows={6}
                        className="block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 sm:text-sm p-2 border font-mono bg-gray-50"
                ...
                <div className="flex justify-between items-center mb-2">
                    ...
                    <div className="flex bg-gray-200 rounded p-1">
                        <button
                            ...
                            className={`px-3 py-1 text-xs rounded transition-all ${testCaseMode === 'text' ? 'bg-white shadow text-blue-600 font-bold' : 'text-gray-600'}`}
                        >
                            Text Mode
                        </button>
                        <button
                            ...
                            className={`px-3 py-1 text-xs rounded transition-all ${testCaseMode === 'file' ? 'bg-white shadow text-blue-600 font-bold' : 'text-gray-600'}`}
                        >
                            File Mode
                        </button>
                    </div>
                                ...
                                <div key={field.id} className="flex gap-4 items-start bg-gray-50 p-3 rounded-md border">
                                    <div className="flex-1">
                                        ...
                                        <textarea
                                            ...
                                            rows={2}
                                            className="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 sm:text-xs p-1 border font-mono"
