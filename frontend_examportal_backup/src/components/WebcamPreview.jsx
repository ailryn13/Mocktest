...
export default function WebcamPreview({ videoRef, faceCount, detectedObjects, modelsLoaded, cameraStatus, headRotation }) {
    return (
        <div className="fixed bottom-6 left-6 z-50">
            <div className="prof-panel overflow-hidden border-2 border-blue-500/20 shadow-2xl">
                {/* Video Preview */}
                <div className="relative">
                    {/* Camera Status Overlays */}
                    {cameraStatus === 'error' && (
                        <div className="absolute inset-0 bg-gray-950 flex flex-col items-center justify-center text-center p-4 z-10">
                            <span className="text-2xl mb-2">🚫</span>
                            <p className="text-rose-500 font-bold text-xs uppercase tracking-widest">Signal Error</p>
                            <p className="text-gray-500 text-[10px] leading-tight mt-2 px-2">
                    ...
                    {cameraStatus === 'loading' && (
                        <div className="absolute inset-0 bg-gray-950 flex flex-col items-center justify-center text-center z-10">
                            <div className="prof-spinner mb-3"></div>
                            <p className="text-blue-400 font-bold text-[10px] uppercase tracking-widest">Initializing Optic...</p>
                        </div>
                    )}
                    ...
                    <div className="absolute top-2 left-2 right-2 flex justify-between items-start">
                        {/* AI Status */}
                        <div className={`px-2 py-0.5 rounded text-[10px] font-bold uppercase tracking-tighter ${modelsLoaded ? 'bg-blue-600' : 'bg-gray-700'
                ...
                {/* Info Bar */}
                <div className="bg-gray-900 px-3 py-1.5 flex items-center justify-between border-t border-white/5">
                    <span className="text-[10px] font-bold text-gray-500 uppercase tracking-widest">Secure Feed</span>
