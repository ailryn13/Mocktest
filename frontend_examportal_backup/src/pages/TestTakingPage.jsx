        ...
        return (
            <div className="min-h-screen bg-gray-950 flex items-center justify-center">
                <div className="text-center">
                    ...
                    <p className="text-gray-400 font-bold uppercase tracking-widest text-[10px]">Initializing Assessment Pipeline...</p>
                </div>
            </div>
        );
    }
        ...
        return (
            <div className="min-h-screen bg-gray-950 flex items-center justify-center p-6">
                <div className="max-w-3xl w-full relative">
                    ...
                    <div className="prof-panel p-10 relative z-10 border-t-4 border-t-blue-500">
                        <div className="text-center mb-10">
                            <div className="w-16 h-16 bg-blue-500/10 rounded-2xl flex items-center justify-center mx-auto mb-6 border border-blue-500/20">
                                <ClipboardList className="w-8 h-8 text-blue-400" />
                            </div>
                            <h1 className="text-4xl font-bold text-white mb-3 tracking-tight">{test?.title}</h1>
                            <p className="text-gray-400 text-lg max-w-xl mx-auto">{test?.description}</p>
                        </div>

                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-10">
                            <div className="prof-card p-6 bg-gray-900/50 flex items-center gap-4 group hover:border-blue-500/30 transition-colors">
                        ...
                        {isExpired ? (
                            <div className="p-6 bg-rose-500/10 border border-rose-500/20 rounded-2xl text-center mb-6">
                                ...
                                <p className="text-gray-500 text-xs">The allocated time for this attempt has passed. You can no longer begin this session.</p>
                            </div>
                        ) : (
                            <button
                                onClick={handleBeginTest}
                                className="w-full btn-primary py-5 text-sm font-bold uppercase tracking-[0.3em] flex items-center justify-center gap-4 shadow-[0_10px_40px_rgba(99,102,241,0.3)] hover:shadow-blue-500/40 transition-all hover:scale-[1.02] active:scale-[0.98]"
                            >
                        ...
                        <p className="text-center text-gray-600 text-[10px] mt-8 font-bold uppercase tracking-widest opacity-50">
                ...
                <div className="max-w-[1600px] mx-auto px-6 h-20 flex justify-between items-center">
                    <div className="flex items-center gap-8">
                        <button
                            ...
                            className="flex items-center gap-2 px-4 py-2 bg-gray-900 hover:bg-gray-800 text-gray-400 hover:text-white rounded-xl transition-all border border-white/5 group"
                        >
                        ...
                        <div>
                            ...
                            <div className="flex items-center gap-3">
                                <span className="text-[10px] font-bold text-gray-500 uppercase tracking-widest">Question Workspace</span>
                                <div className="flex items-center gap-1.5">
                                    <div className="w-1 h-1 rounded-full bg-blue-500 animate-pulse"></div>
                                    <span className="text-xs font-bold text-blue-400">Live Session Attempt</span>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="flex items-center gap-10">
                        <div className="text-right">
                            <p className="text-[10px] font-bold text-gray-500 uppercase tracking-widest mb-1">Remaining Time</p>
                        ...
                        <button
                            ...
                            className="btn-primary py-3 px-8 shadow-lg shadow-blue-500/20"
                        >
                            Finalize Attempt
                        </button>
                    </div>
                ...
                <div className="col-span-3 xl:col-span-2 flex flex-col gap-6 overflow-y-auto pr-2 scrollbar-none">
                    ...
                    <div className="prof-panel p-5 flex flex-col">
                        <div className="flex items-center justify-between mb-6">
                            <h3 className="text-[10px] font-bold text-gray-500 uppercase tracking-widest">Test Navigation</h3>
                            <span className="text-[10px] font-bold text-blue-400 py-1 px-2 bg-blue-500/10 rounded-lg">
                        ...
                        <div className="flex-1 space-y-8">
                            {Object.entries(questions.reduce((acc, q, idx) => {
                                ...
                                <div key={section}>
                                    <h4 className="text-[9px] font-bold text-gray-600 uppercase tracking-tighter mb-4 flex items-center gap-2">
                                            ...
                                            <button
                                                ...
                                                className={`aspect-square rounded-xl text-xs font-bold transition-all border-2 ${idx === currentQuestionIndex
                                                    ...
                                                    : answers[q.id] || codeAnswers[q.id]
                                                        ...
                                                        : 'bg-gray-900/50 text-gray-500 border-white/5 hover:border-gray-700 hover:text-gray-300'
                                                    }`}
                                            >
                                                {idx + 1}
                                            </button>
                    ...
                    <div className="prof-panel p-5 mt-auto">
                        <div className="flex items-center gap-3 mb-4">
                            ...
                            <div>
                                <p className="text-[10px] font-bold text-gray-500 uppercase tracking-widest leading-none mb-1">Security</p>
                                <p className="text-xs font-bold text-emerald-400 uppercase tracking-tight">System Active</p>
                            </div>
                        </div>

                        {!loading && attempt && (
                            <div className="rounded-xl overflow-hidden border border-white/5 bg-gray-900/50 aspect-video relative group">
                                <WebcamPreview
                                    videoRef={videoRef}
                                    faceCount={faceCount}
                        ...
                        <div className="mt-4 pt-4 border-t border-white/5 flex gap-4">
                            <div className="flex-1">
                                <p className="text-[9px] font-bold text-gray-600 uppercase tracking-widest mb-1">Violations</p>
                            ...
                            <div className="flex-1 text-right">
                                ...
                                <p className="text-xs font-bold text-blue-400 uppercase">Verified</p>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div className="prof-panel flex-1 flex flex-col min-h-0 overflow-hidden relative">
                        ...
                        <div className="px-8 py-4 border-b border-white/5 flex justify-between items-center bg-white/[0.02]">
                            <div className="flex items-center gap-4">
                                ...
                                <span className="text-[10px] font-bold text-gray-500 uppercase tracking-widest">Weight: {currentQuestion?.marks} Point(s)</span>
                            </div>

                            <div className="flex items-center gap-2">
                                <div className="w-2 h-2 rounded-full bg-emerald-500"></div>
                                <span className="text-[10px] font-bold text-gray-500 uppercase tracking-widest">Auto-save synchronization active</span>
                            </div>
                        </div>
                        ...
                        <div className="flex-1 overflow-y-auto p-10 scrollbar-thin scrollbar-thumb-white/10">
                            {currentQuestion && (
                                <div className="max-w-4xl">
                                    <div className="mb-12">
                                        <h3 className="text-gray-500 text-[10px] font-bold uppercase tracking-widest mb-4">Problem Statement</h3>
                                    ...
                                    {currentQuestion.type === 'MCQ' && (
                                        <div className="space-y-4">
                                            <h3 className="text-gray-500 text-[10px] font-bold uppercase tracking-widest mb-6">Select Option</h3>
                                                ...
                                                {['A', 'B', 'C', 'D'].map((option) => (
                                                    <label
                                                        ...
                                                        className={`flex items-start p-6 rounded-2xl border-2 transition-all cursor-pointer group ${answers[currentQuestion.id] === option
                                                            ? 'border-blue-500 bg-blue-500/5 shadow-[0_0_20px_rgba(99,102,241,0.1)]'
                                                    ...
                                                    >
                                                        ...
                                                        <input
                                                            ...
                                                            className="hidden"
                                                        />
                                                        <span className={`text-lg font-medium pt-0.5 transition-colors ${answers[currentQuestion.id] === option ? 'text-white' : 'text-gray-400 group-hover:text-gray-300'}`}>
                                    ...
                                    {currentQuestion.type === 'CODING' && (
                                        <div className="space-y-6">
                                            <div className="flex justify-between items-end">
                                                <h3 className="text-gray-500 text-[10px] font-bold uppercase tracking-widest">Integrated Development Environment</h3>
                                                <div className="flex items-center gap-4">
                                                    <span className="text-[10px] font-bold text-gray-600 uppercase tracking-widest">Select Runtime</span>
                                                    <select
                                                        className="bg-gray-900 text-blue-400 border border-blue-500/20 rounded-lg px-4 py-2 text-xs font-bold outline-none focus:ring-1 focus:ring-blue-500 transition-all appearance-none cursor-pointer"
                                            ...
                                            <div className="prof-card p-0 overflow-hidden flex flex-col min-h-[500px] border-white/5">
                                                <div className="bg-gray-900/80 px-4 py-2 flex items-center justify-between border-b border-white/5">
                                                    ...
                                                    <span className="text-[10px] font-bold text-gray-600 uppercase tracking-widest mono">source_code_buffer.v8</span>
                                                </div>
                                                <textarea
                                                    ...
                                                    className="flex-1 w-full p-8 bg-gray-950/50 text-blue-200 font-mono text-sm resize-none outline-none leading-relaxed placeholder-gray-700"
                                                    placeholder="// Implementation logic goes here..."
                                                    spellCheck="false"
                                                />
                                                <div className="p-4 border-t border-white/5 bg-gray-900/40 flex justify-between items-center">
                                                    <button
                                                        onClick={() => handleRunCode(currentQuestion.id)}
                                                        disabled={isExecuting}
                                                        className="px-6 py-2.5 bg-blue-600 hover:bg-blue-700 disabled:bg-gray-800 text-white text-xs font-bold rounded-xl transition-all flex items-center gap-3 shadow-lg shadow-blue-600/20"
                                                    >
                                                    ...
                                                    <div className="flex items-center gap-4">
                                                        <span className="text-[9px] text-gray-600 font-bold uppercase tracking-widest">Environment: Linux (v.Latest)</span>
                                            ...
                                            {executionResults[currentQuestion.id] && (
                                                <div className="prof-card p-6 bg-gray-950/80 border-l-4 border-l-blue-500 animate-in slide-in-from-bottom-2 duration-300">
                                                    {executionResults[currentQuestion.id].error && executionResults[currentQuestion.id].error.startsWith("LOGIC BLOCK:") ? (
                                                        ...
                                                        <div className="space-y-6">
                                                            <div className="flex items-center justify-between border-b border-white/5 pb-4">
                                                                <h4 className="text-[10px] font-bold text-gray-500 uppercase tracking-widest">Execution Result Pipeline</h4>
                                                            ...
                                                            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                                                <div className="space-y-3">
                                                                    <div className="flex items-center gap-2">
                                                                        ...
                                                                        <span className="text-[10px] font-bold text-gray-500 uppercase tracking-widest">Captured Output</span>
                                                                    </div>
                                                                    <pre className="text-emerald-400/90 text-sm font-mono bg-gray-950 p-4 rounded-xl border border-white/5 overflow-x-auto min-h-[100px]">
                                                                ...
                                                                <div className="space-y-6">
                                                                    <div className="flex justify-between items-center bg-gray-900/50 p-4 rounded-xl border border-white/5">
                                                                        <span className="text-[10px] font-bold text-gray-500 uppercase tracking-widest">Runtime Status</span>
                                                                        <span className="text-xs font-bold text-white font-mono uppercase">
                                                                            {executionResults[currentQuestion.id].status?.description || 'TERMINATED'}
                                                                        </span>
                                                                    </div>
                                                                    <div className="flex justify-between items-center bg-gray-900/50 p-4 rounded-xl border border-white/5">
                                                                        <span className="text-[10px] font-bold text-gray-500 uppercase tracking-widest">Time (ms)</span>
                        ...
                        <div className="px-8 py-6 border-t border-white/5 flex justify-between items-center bg-white/[0.02]">
                            <button
                                ...
                                className="flex items-center gap-3 px-8 py-3 bg-gray-900 hover:bg-gray-800 disabled:opacity-20 text-gray-300 font-bold text-xs uppercase tracking-widest rounded-xl transition-all border border-white/5"
                            >
                            ...
                            <div className="flex items-center gap-6">
                                <div className="text-right hidden sm:block">
                                    <p className="text-[9px] font-bold text-gray-600 uppercase tracking-widest">Question Information</p>
                                    <p className="text-[10px] font-bold text-gray-400 uppercase tracking-tight">System state verified & locked</p>
                                </div>
                    ...
                    <div className="prof-panel p-10 max-w-lg w-full border-t-4 border-t-emerald-500 animate-in zoom-in-95 duration-300">
                        ...
                        <div className="flex gap-4">
                            ...
                            <button
                                ...
                                className="flex-1 py-4 bg-gray-900 hover:bg-gray-800 text-gray-300 rounded-xl transition-all font-bold uppercase tracking-widest text-xs border border-white/5"
                            >
                                Continue Working
                            </button>
                        </div>
